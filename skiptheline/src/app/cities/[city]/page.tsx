...
import { MapPin, Users, Star, Calendar, Filter, Search, ArrowLeft, Building2 } from 'lucide-react';
...
export default function CityClubsPage() {
  ...
  const cityClubs = clubs.filter(club => club.city === cityName && club.status === 'active');
  const activeEvents = events.filter(event => event.status === 'active');

  const filteredClubs = cityClubs.filter(club => {
          ...
          <div className="text-center py-16">
            <div className="card-spacing glass-effect rounded-3xl max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-gray-300 element-spacing">
                No Venues in {cityName}
              </h3>
              <p className="text-gray-500 text-lg leading-relaxed mb-6">
                We don't have any venues in {cityName} yet. Check back soon or explore other cities!
              </p>
              <Link
                href="/cities"
    ...
    <div className="min-h-screen bg-background gradient-bg">
      ...
      <div className="container-responsive section-spacing">
        ...
        <div className="mb-8">
          <Link
            href="/cities"
            className="inline-flex items-center text-gray-400 hover:text-neon-pink transition-colors"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-6 element-spacing">
          <div className="relative flex-1">
            <input
              type="text"
              placeholder={`Search clubs in ${cityName}...`}
              value={searchQuery}
          ...
          <div className="text-center py-16">
            <div className="card-spacing glass-effect rounded-3xl max-w-md mx-auto">
              ...
              <p className="text-gray-500 text-lg leading-relaxed">
                Try adjusting your search or filter to find the perfect venue in {cityName}.
              </p>
            </div>
          </div>
        )}
